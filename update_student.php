...
$newId=$_GET['s_id'];
echo $newId;
$exec_query =mysqli_query($connection,"SELECT * FROM student_reg_table WHERE student_id='$newId'");
...
if(isset($_POST['btn_update']))
{
    ...
    $query="UPDATE student_reg_table SET name='$name', contact='$mobile', email='$email', username='$username', password='$password', confirm_password='$confirm_password' WHERE student_id='$newId'";
