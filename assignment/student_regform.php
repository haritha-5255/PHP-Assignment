...
if(isset($_POST['btn_add']))
{
    ...
    $query="INSERT INTO users( name, contact, email, username, password,role,status)VALUES('$name','$mobile','$email','$username','$password','$roles','$status')";
    ...
    <div class="container-fluid">
        <div class="container">
		  ...
		  <select class="form-select"
			  ...
			  <option selected value="role">student</option>
